...
class ProcessingAuditoriaScreen extends StatefulWidget {
  final OT ot;
  ...
  const ProcessingAuditoriaScreen({
    Key? key,
    required this.ot,
  ...
  @override
  State<ProcessingAuditoriaScreen> createState() =>
      _ProcessingAuditoriaScreenState();
}

class _ProcessingAuditoriaScreenState extends State<ProcessingAuditoriaScreen> {
