...
class _RegistroManualPageState extends State<RegistroManualPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final form = FormGroup({
      ...
      'latitud': FormControl<double>(value: 0),
      'longitud': FormControl<double>(value: 0),
    });
                            ...
                            children: <Widget>[
                              ...
                              ReactiveValueListenableBuilder<String>(
                                  ...
                                  builder: (context, departamento, child) {
                                    return SOSeleccionUnicaFieldCustom(
                                      campo: "municipio",
                                      label: "Municipio",
                                      listaValores: [
                                        ...municipios
